...
function Register(props) {
    ...
    return(
        <div className="w-full max-w-sm">
            <form onSubmit={initiateUserRegisteration} className="flex flex-col gap-5 rounded-3xl border border-[#ece5d8] bg-[#fdfbf6] p-10 shadow-sm">
                <h2 className="text-center font-serif text-4xl text-gray-900">Register</h2>
